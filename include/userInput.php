        ...
        <?php
            ...
            $query = "INSERT INTO user (userlistid, firstName, lastName, address, contactno, photo, additionalinfo, status) VALUES ('$sample', '$firstName', '$lastName', '$address', '$contact', 'images/Customers/bp.png', ' ', 'Pending');";
