            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        INNER JOIN petstatus c ON a.StatusID = c.StatusID  WHERE a.IsFeatured='Yes' and a.categoryid='$cattid'";
                        ...
                        a.PetName, a.Quantity, a.Reason, a.DateSold, a.Image, a.Image2, a.Image3, a.IsFeatured, b.CategoryID, 
                        b.Category, c.StatusID, c.Status FROM pet a INNER JOIN petcategory b ON a.CategoryID = b.CategoryID 
                        INNER JOIN petstatus c ON a.StatusID = c.StatusID  WHERE a.categoryid='$cattid' LIMIT $start, $limit";
                        ...
                        a.PetName, a.Quantity, a.Reason, a.DateSold, a.Image, a.Image2, a.Image3, a.IsFeatured, b.CategoryID, 
                        b.Category, c.StatusID, c.Status FROM pet a INNER JOIN petcategory b ON a.CategoryID = b.CategoryID 
                        INNER JOIN petstatus c ON a.StatusID = c.StatusID  WHERE a.IsFeatured='Yes' and a.categoryid='$cattid' LIMIT $start, $limit";
                        ...
                        a.PetName, a.Quantity, a.Reason, a.DateSold, a.Image, a.Image2, a.Image3, a.IsFeatured, b.CategoryID, 
                        b.Category, c.StatusID, c.Status FROM pet a INNER JOIN petcategory b ON a.CategoryID = b.CategoryID 
                        INNER JOIN petstatus c ON a.StatusID = c.StatusID  WHERE a.IsFeatured='Yes' order by $sort LIMIT $start, $limit";
                                }
                          ...
                          die("Query failed: " . $conn->error);
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 thumbnail">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <a href="include/petDetails?ID=<?php echo $row['PetID'] ?>" style="text-decoration: none;">
                                ...
                                <center>
                                    <a href="account/addToCart?ID=<?php echo $row['PetID'] ?>" class="btn btn-stylish" role="button" title="Add to Cart"><i class="fa fa-shopping-cart"></i></a>
                                    <a href="include/addToCart" class="btn btn-stylish" role="button" title="Add to Wishlist"><i class="fa fa-heart-o"></i></a>
                                </center>
                                <br>
                            </div>
                            <?php
                        ...
                        <?php
                            ...
                            if(!isset($_GET['ID'])) { 
                                $paging = "SELECT a.PetID, a.CategoryID, a.Breed, a.Price, a.Available, PetBirthdate, a.Description, a.StatusID, a.UserID, 
                        a.PetName, a.Quantity, a.Reason, a.DateSold, a.Image, a.Image2, a.Image3, a.IsFeatured, b.CategoryID, 
                        b.Category, c.StatusID, c.Status FROM pet a INNER JOIN petcategory b ON a.CategoryID = b.CategoryID 
                        INNER JOIN petstatus c ON a.StatusID = c.StatusID  WHERE a.IsFeatured='Yes' order by $sort";
